...
As indicated in my previous post, I am going to analyse a tidy tuesday dataset for this blogpost. I will be using the R programming language and the excellent series of packages called the tidyverse.

This week's tidy tuesday dataset is about anime, and comes from MyAnimeList.net. I find this especially exciting since I have  enjoyed quite a bit of anime in my life - much to the dismay of my girlfriend. However I am sure I will be able to find an anime series to win her over - at least to some extent! Hopefully this dataset wil be able to help! At the very least I should be able to see where my favourite series rank.
...
However some anime have been listed multiple times (e.g. Gintama). This seems to be caused by the different seasons having separate ratings.
...
I am a bit suprised about Swort Art Online scoring so high in the above list. However it did have a novel plot line, especially in the first half of season one. 
...
Luckily she gave a me a good starting point when she mentioned that the one anime she has seen and really enjoyed was 'The Red turtle' by Studio Gibli. Even though it is not in this dataset, at least the producer of this anime is in here. Lets see if they made any other highly rated anime.
